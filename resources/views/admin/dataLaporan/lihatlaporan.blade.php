...
<body>
    ...
    <div class="header">
        ...
        <h2 align="center">Riwayat Diagnosa Plants Shop Guyung</h2>
        <h4 align="center">Jln. Raya Kendal-Ngawi, Ds.Guyung, Kec.Gerih, Kab.Ngawi Jawa Timur 63272</h4>
        <h1></h1>
        <hr />
        <br>
    </div>
    ...
    <table border="1" align="center" width="100%" id="data-laporan" class="table table-bordered table-hover">
        ...
        <tbody>
            <tr class="text-center">
                ...
                <td>Fabio</td>
                <td>2022-12-28</td>
                <td>(G-01) Disebabkan oleh Jamur Collectricum Mangifirae, (G-07) Bagian terserang adalah buah, (G-08)
                    Muncul bercak warna coklat
                <td>Busuk Buah </td>
                <td>Penyemprotan fungisida Velimex 80 WP dengan dosis 2,5 gram dan pemberian jarak dalam penanaman</td>
                <td>Fungisida VELIMEX 80wp </td>
            </tr>
    ...
    <p align=right style="width:100%;">Madiun, 03-Mar-2023</p>
